...
# Gene Rectangles
gene_shapes <- lapply(seq_along(gene_start), function(i) {
  list(
    type = "rect",
...
final_shapes <- c(gene_shapes, list(hline(75)))
...
> **Figure 3.** Subconsensus Variant Read Counts. The sample pileup was analyzed to find positions in the genome where the non-reference allele percentage was >=15%.
